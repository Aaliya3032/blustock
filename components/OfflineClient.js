           ...
           >
             ...
             <div className="flex flex-row gap-2 items-center justify-between rounded-b-lg px-4 py-6 bg-secondary text-white">
               ...
               <Link href={`/courses/${course.id}`} className="z-20 relative inline-flex items-center justify-center text-justify lg:px-5 md:px-2 sm:px-5 px-2 lg:py-3 md:py-2 sm:py-3 py-2 overflow-hidden font-bold rounded-full group cursor-pointer">
                 ...
                 <span  className="relative w-full text-left px-2 text-white lg:text-lg md:text-xs sm:text-lg text-xs transition-colors duration-200 ease-in-out group-hover:text-primary">
                   ENROLL NOW
                 </span>
