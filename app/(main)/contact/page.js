        ...
        <div className="flex sm:flex-row flex-col justify-center gap-4 w-full">
          ...
          >
            <div className="flex flex-col justify-between relative z-10 md:p-8 p-4 h-full lg:gap-6 md:gap-4 gap-3">
               ...
               <div className="text-black lg:text-md sm:text-sm text-xs mb-2 break-words">Plot 212/A, Joshi Marg, Jhotwara, Jaipur ( 302012 )</div>
               <Link
          ...
          >
             <div className="flex flex-col justify-between relative z-10 md:p-8 p-4 h-full lg:gap-6 md:gap-4 gap-3">
               ...
               <div className="text-black lg:text-md sm:text-sm text-xs mb-2 break-words">+91 6376-520654</div>
               <Link
          ...
          >
             <div className="flex flex-col justify-between relative z-10 md:p-8 p-4 h-full lg:gap-6 md:gap-4 gap-3">
               ...
               <div className="text-black lg:text-md sm:text-sm text-xs  mb-2 break-words">blustockconsultants@gmail.com</div>
               <Link
